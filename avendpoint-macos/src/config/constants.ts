...
export const MACOS_PATHS = {
  CONFIG:               '/Library/Application Support/EndpointAgent/config.json',
  NORTON_APP_PLIST:     '/Applications/Norton.app/Contents/Info.plist',
  NORTON_LICENSE:       '/Library/Application Support/Norton/state/license_leap.data',
  NORTON_ACTIVITY_DB:   '/Library/Application Support/Norton/state/activity/activity.db',
  NORTON_DIR:           '/Applications/Norton.app',
};
