        ...
        <tbody>
          {endpoints.map((endpoint) => (
            <tr>
              ...
              <td>{endpoint.antivirus?.filesScanned ?? "N/A"}</td>
              <td>{endpoint.antivirus?.threatsDetected ?? "N/A"}</td>
              <td>{endpoint.antivirus?.threatsResolved ?? "N/A"}</td>
              <td>{endpoint.antivirus?.quarantineCount ?? "N/A"}</td>
              <td>{endpoint.antivirus?.lastProtectionEvent ?? "N/A"}</td>
              <td>
